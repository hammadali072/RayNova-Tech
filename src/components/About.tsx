...
export function About() {
  return (
    <section id="about" className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-[600px] h-[600px] bg-gradient-to-r from-[#0e3b2c]/15 to-transparent rounded-full blur-3xl animate-pulse-glow"></div>
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gradient-to-l from-[#c9a227]/10 to-transparent rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '1.5s' }}></div>

      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          {/* Left: Image */}
          <div className="relative group">
            <div className="absolute -inset-6 bg-gradient-to-r from-[#c9a227]/30 via-[#d4b13f]/20 to-[#0e3b2c]/30 rounded-[3rem] blur-3xl group-hover:blur-2xl transition-all duration-700 opacity-75 group-hover:opacity-100"></div>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-[#c9a227]/20 to-[#0e3b2c]/20 rounded-3xl blur-xl"></div>
              <ImageWithFallback
              ...
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-gradient-to-br from-[#c9a227] via-[#d4b13f] to-[#0e3b2c] rounded-3xl opacity-60 blur-2xl animate-float"></div>
              <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-gradient-to-tr from-[#0e3b2c] via-[#c9a227] to-[#d4b13f] rounded-3xl opacity-50 blur-2xl animate-float" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
