...
export function Process() {
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden bg-gradient-to-b from-transparent via-[#232323]/20 to-transparent">
      {/* Background */}
            ...
            return (
              <div key={index} className="group relative">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-24 left-full w-full h-px bg-gradient-to-r from-[#c9a227]/30 to-transparent"></div>
                )}

                <div className="relative bg-[#232323]/60 backdrop-blur-xl border border-[#c9a227]/10 rounded-3xl p-8 hover:border-[#c9a227]/40 transition-all duration-500 hover:shadow-[0_20px_60px_rgba(201,162,39,0.2)] h-full">
                  {/* Number */}
                  ...
                  <div className="relative z-10 space-y-6">
                    {/* Icon */}
                    <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-[#c9a227]/20 to-[#0e3b2c]/20 backdrop-blur-sm group-hover:scale-110 transition-all duration-500 shadow-[0_8px_20px_rgba(201,162,39,0.15)]">
